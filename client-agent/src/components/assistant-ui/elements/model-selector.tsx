...
function ModelSelectorContent({
  ...
  return (
    <PopoverContent
      ...
      className={cn(
        "bg-popover text-popover-foreground max-h-[calc(100dvh-1rem)] flex w-72 min-w-(--anchor-width) flex-col overflow-hidden rounded-xl p-0",
        className,
      )}
      {...props}
    >
...
function ModelSelectorEffort({
  ...
  return (
    <div
      ...
      className={cn(
        "flex cursor-default flex-wrap items-center justify-between gap-x-3 gap-y-1 border-t px-3 py-2",
        className,
      )}
      onKeyDownCapture={(e) => {
        onKeyDownCapture?.(e);
